...
<body>
    <div>
        ...
        <a href="updateInfo.jsp?name=${requestScope.employee_name}&type=1">添加药品</a><br>
    ...
    <table border="1" style="margin:auto;">
        ...
        <c:forEach items="${allDrugList}" var="record">
            <tr>
                ...
                <td>${record.price}</td>
                <td>
                    <a href="updateDrug.jsp?drug_id=${record.drug_id}&employee_name=${requestScope.employee_name}&job_id=${requestScope.job_id}&drug_name=${record.drug_name}&manufacturer=${record.manufacturer}&price=${record.price}">更新或删除</a>
                    <a href="email.jsp?teacher=${record.manufacturer}">补货</a>
                </td>
            </tr>
        </c:forEach>
    </table>
